  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="centro-psicologico-quesada";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Centro Psicologico Quesada del Valle"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="centro-psicologico-quesada"
          data-primary-color="#3368c1"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="centro-psicologico-quesada";
